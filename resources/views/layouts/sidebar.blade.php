...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Mantan</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('view-any', App\Models\College::class)
                            <li class="nav-item">
                            ...
                            @endcan
                            @can('view-any', App\Models\HoD::class)
                            <li class="nav-item">
                                <a href="{{ route('ho-ds.index') }}" class="nav-link">
                                    <i class="nav-icon icon ion-md-radio-button-off"></i>
                                    <p>Ho Ds</p>
                                </a>
                            </li>
                            ...
                            @endcan
                            @can('view-any', App\Models\ActivityType::class)
                            <li class="nav-item">
